...
export default function (props) {
  ...
  const [like, setlike] = useState({ count: 2, action: false });
  ...
  const handleLikeChange = () => {
    setlike((prev) => ({ ...prev, count: prev.count + 1, action: true }));
  };
    ...
    <>
      <div>
        <Modal isOpen={modal1} toggle1={toggle1}>
          <ModalHeader
            toggle1={toggle1}
            style={{ backgroundColor: "#04162C", borderColor: "#0b2e5c" }}
          >
            <div className="row ">
              <dv className="col-md-6">
                <IoHeartOutline color="#0275d8" size="1.5em" />
                Likes
              </dv>
              <dv className="col-md-6">
                <button
                  ...
                  onClick={toggle1}
                  style={{ marginLeft: 200, borderRadius: 20 }}
                >
                  Close
                </button>
              </dv>
          ...
          <ModalBody style={{ backgroundColor: "#04162C" }}>
            <div className="row pt-2 notificationRow">
              ...
              <div className="col-md-7 text-white mt-2 ml-1">
                <p>
                  Yasir Ado Hassan <span className="text-secondary"></span>
                </p>
              </div>
            </div>
          </ModalBody>
      ...
      <div>
        <Modal isOpen={modal3} toggle3={toggle3} className={className}>
          ...
          >
            <div className="row">
              <dv className="col-md-6">
                <IoChatboxEllipsesOutline color="#0275d8" size="1.5em" />{" "}
                Comments
              </dv>
              <dv className="col-md-6">
                <button
                  className="btn btn-outline-primary"
                  onClick={toggle3}
                  style={{ marginLeft: 180, borderRadius: 20 }}
                >
                  Close
                </button>
              </dv>
          ...
          <ModalBody style={{ backgroundColor: "#04162C" }}>
            <div className="row pt-2 notificationRow">
              ...
              <div className="col-md-7 text-white mt-2 ml-1">
                ...
                <p>
                  Comment: <span>Comment appears here</span>
                </p>
              </div>
            </div>
          </ModalBody>
      ...
      <div>
        <Modal isOpen={modal5} toggle5={toggle5} className={className}>
          ...
          <ModalBody style={{ backgroundColor: "#04162C" }}>fghjkl;</ModalBody>
        </Modal>
      </div>
      <div className="col mt-2 text-white text-center">
        {like.action ? (
          <IoHeart color="#0275d8" size="1.5em" onClick={handleLikeChange} />
        ) : (
          <IoHeartOutline
            color="#0275d8"
            size="1.5em"
        ...
        <span className="postEngagements" onClick={toggle1}>
          {like.count}
        </span>
      </div>
      <div className="col mt-2 text-white text-center">
        ...
        />{" "}
        <span className="postEngagements" onClick={toggle3}>
          {comment}
        </span>
      </div>
      <div className="col mt-2 text-white text-center">
        ...
        />{" "}
        <span className="postEngagements" onClick={toggle4}>
          {share}
        </span>
      </div>
      <div className="col mt-2 text-white text-center">
        ...
        />{" "}
        <span className="postEngagements" onClick={toggle5}>
          {download}
        </span>
      </div>
    </>
